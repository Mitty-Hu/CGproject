...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(680, 230, 281, 161))
        self.groupBox.setObjectName("groupBox")
        self.checkbox_face = QtWidgets.QCheckBox(self.groupBox)
        self.checkbox_face.setGeometry(QtCore.QRect(10, 20, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        ...
        self.button_Capture.setGeometry(QtCore.QRect(170, 80, 40, 40))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(-1)
...
"padding-right:10px;")
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 0, 661, 391))
        self.groupBox_2.setObjectName("groupBox_2")
        self.label_ShowCamera = QtWidgets.QLabel(self.groupBox_2)
        self.label_ShowCamera.setGeometry(QtCore.QRect(10, 20, 640, 360))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(680, 0, 281, 231))
        ...
        self.actionCloseWindow.setIcon(icon5)
        ...
        self.toolBar.addAction(self.actionCloseWindow)

        self.retranslateUi(MainWindow)
        self.actionCloseWindow.triggered.connect(MainWindow.close)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCloseWindow.setText(_translate("MainWindow", "CloseWindow"))
        self.actionCloseWindow.setToolTip(_translate("MainWindow", "关闭窗口"))
